...
int main()
{
    ...
    salesman salesman_c("0003", "zyu");
    salesmanager salesmanager_d("0004", "dcy");

    manager_a.ShowSalary();
    technician_b.ShowSalary();
    salesman_c.ShowSalary();
    salesmanager_d.ShowSalary();
